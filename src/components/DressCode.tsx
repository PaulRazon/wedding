      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="habibi-regular text-lg text-[#5a4a3a] max-w-3xl mx-auto leading-relaxed mb-4">
            ...
            <span className="font-semibold text-[#7ba3c8]">azul</span>, por lo que te pedimos no utilizarlo.
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div
            className={`bg-white/90 backdrop-blur-md rounded-3xl p-8 border-2 border-[#c5e3f5]/60 shadow-2xl shadow-[#a8d8f0]/20 transition-all duration-1000 delay-200 hover:shadow-3xl hover:scale-[1.02] ${
              isVisible ? "animate-fade-in-up opacity-100" : "opacity-0"
            }`}
          >
            <div className="mb-6 text-center">
              <h3 className="great-vibes-regular text-4xl font-medium text-[#7ba3c8] mb-4">Mujeres</h3>
          ...
          <div
            className={`bg-white/90 backdrop-blur-md rounded-3xl p-8 border-2 border-[#c5e3f5]/60 shadow-2xl shadow-[#a8d8f0]/20 transition-all duration-1000 delay-300 hover:shadow-3xl hover:scale-[1.02] ${
              isVisible ? "animate-fade-in-up opacity-100" : "opacity-0"
            }`}
          >
            <div className="text-center">
              <h3 className="great-vibes-regular text-4xl font-medium text-[#7ba3c8] mb-6">Hombres</h3>

              <div className="flex items-start gap-3 bg-[#f5fbfd]/60 rounded-lg p-6 border-2 border-[#c5e3f5]">
                ...
                <div className="text-left">
                  <p className="habibi-regular text-base text-[#5a4a3a] leading-relaxed">
                    ...
                    <span className="font-semibold text-[#7ba3c8]">azul</span>.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div
          className={`bg-white/90 backdrop-blur-md rounded-3xl p-8 border-2 border-[#c5e3f5]/60 shadow-2xl shadow-[#a8d8f0]/20 transition-all duration-1000 delay-400 mb-8 hover:shadow-3xl hover:scale-[1.02] ${
            isVisible ? "animate-fade-in-up opacity-100" : "opacity-0"
          }`}
        >
          <div className="flex flex-col items-center text-center gap-4">
            <div className="relative">
              ...
              <div className="relative w-16 h-16 rounded-full bg-gradient-to-br from-[#f5fbfd] to-[#f0f9fd] flex items-center justify-center flex-shrink-0 shadow-md">
                <Clock className="h-8 w-8 text-[#7ba3c8]" />
              </div>
            </div>
            <div>
              <h4 className="great-vibes-regular text-4xl font-medium text-[#7ba3c8] mb-4">Llega puntual</h4>
              ...
              <p className="great-vibes-regular text-2xl text-[#7ba3c8] mt-3">
        ...
        <div
          className={`bg-white/90 backdrop-blur-md rounded-3xl p-8 border-2 border-[#c5e3f5]/60 shadow-2xl shadow-[#a8d8f0]/20 transition-all duration-1000 delay-500 hover:shadow-3xl hover:scale-[1.02] ${
            isVisible ? "animate-fade-in-up opacity-100" : "opacity-0"
          }`}
        >
          <div className="flex flex-col items-center text-center gap-4">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-[#a8d8f0] to-[#8cc9e0] rounded-full blur-xl opacity-40 animate-pulse"></div>
              <div className="relative w-16 h-16 rounded-full bg-gradient-to-br from-[#f5fbfd] to-[#f0f9fd] flex items-center justify-center flex-shrink-0 shadow-md">
                <Camera className="h-8 w-8 text-[#7ba3c8]" />
              </div>
            </div>
            <div>
              <h4 className="great-vibes-regular text-4xl font-medium text-[#7ba3c8] mb-4">Momentos mágicos</h4>
